        ...
        >
            ...
            <div className='w-full flex justify-between items-center lg:hidden'>
                <nav>
                    ...
                    <CustomLink href="mailto:isaurabh.meshram2807@gmail.com" target={"_blank"} title="Contact Me" className='ml-4' />
                </nav>
            ...
            '>
                        <nav className='flex items-center flex-col justify-center'>
                            ...
                            <CustomMobileLink href="mailto:isaurabh.meshram2807@gmail.com" target={"_blank"} title="Contact Me" className='' toggle={handleClick} />
                        </nav>
            ...
            <div className='absolute left-[50%] top-2 translate-x-[50%] md:left-[35%] sm:left-[35%] xs:left-[35%]'>
                <Logo />
            </div>
        </header>
    )
