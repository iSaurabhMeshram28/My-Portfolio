...
import profilePic from "../../public/images/profile/profilePic-2.png"
...
const about = () => {
    return (
        <>
            <Head>
                <title>Saurabh's | About Page</title>
                ...
                <Layout className='pt-16'>
                    ...
                    <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                        <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8'>
                            ...
                            <p className='font-medium'> Hi, I'm Saurabh, a web developer and UI/UX designer with a passion for creating beautiful, functional,
                        ...
                        bg-light p-8 dark:bg-dark dark:border-light xl:col-span-4 md:order-1 md:col-span-8'>
                            ...
                            <Image src={profilePic} alt='w-full h-auto rounded-2xl' 
                             priority
